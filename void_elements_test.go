...
func TestVoidElementsConfiguration(t *testing.T) {
	t.Run("默认配置不包含 void elements", func(t *testing.T) {
		testDefaultConfigVoidElements(t)
	})

	t.Run("HTML 配置包含标准 void elements", func(t *testing.T) {
		testHTMLConfigVoidElements(t)
	})

	t.Run("手动添加和移除 void elements", func(t *testing.T) {
		testManualVoidElementsManagement(t)
	})

	t.Run("设置完整的 void elements 列表", func(t *testing.T) {
		testSetVoidElementsList(t)
	})

	t.Run("大小写敏感性测试", func(t *testing.T) {
		testCaseSensitivityForVoidElements(t)
	})
}

// testDefaultConfigVoidElements 测试默认配置的void元素
func testDefaultConfigVoidElements(t *testing.T) {
...
// testHTMLConfigVoidElements 测试HTML配置的void元素
func testHTMLConfigVoidElements(t *testing.T) {
	config := HTMLConfig()
...
// testManualVoidElementsManagement 测试手动管理void元素
func testManualVoidElementsManagement(t *testing.T) {
	config := DefaultConfig()
...
// testSetVoidElementsList 测试设置完整的void元素列表
func testSetVoidElementsList(t *testing.T) {
	config := DefaultConfig()
...
// testCaseSensitivityForVoidElements 测试void元素的大小写敏感性
func testCaseSensitivityForVoidElements(t *testing.T) {
	// 大小写敏感配置
	config := DefaultConfig()
...
func TestVoidElementsParsing(t *testing.T) {
	t.Run("HTML style void elements", func(t *testing.T) {
		testHTMLStyleVoidElements(t)
	})

	t.Run("Mixed content with void elements", func(t *testing.T) {
		testMixedContentWithVoidElements(t)
	})

	t.Run("Custom void elements", func(t *testing.T) {
		testCustomVoidElements(t)
	})

	t.Run("Void elements with attributes", func(t *testing.T) {
		testVoidElementsWithAttributes(t)
	})
}

// testHTMLStyleVoidElements 测试HTML风格的void元素
func testHTMLStyleVoidElements(t *testing.T) {
	config := HTMLConfig()
...
// testMixedContentWithVoidElements 测试包含void元素的混合内容
func testMixedContentWithVoidElements(t *testing.T) {
	config := HTMLConfig()
	input := `<div>
		<p>Some text</p>
		<br>
...
// testCustomVoidElements 测试自定义void元素
func testCustomVoidElements(t *testing.T) {
	config := DefaultConfig()
...
// testVoidElementsWithAttributes 测试带属性的void元素
